...
contract yTUSD is ERC20, ERC20Detailed, ReentrancyGuard, Structs, Ownable {
  ...
  address public tusd = <<TODO ADD THE TUSD ADDRESS HERE>>;
      ...
      nonReentrant
  {
    ...
    uint256 yeldTUSDToReceive = _amount.mul(yeldTUSDInstance.fromTUSDToYeldTUSDPrice()).div(1 ** yeldTUSDInstance.yeldTUSDDecimals());
