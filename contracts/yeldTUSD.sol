...
contract yeldTUSD is ERC20, ERC20Detailed, Ownable {
  ...
  function setYTUSD(address _yTUSDAddress) public onlyOwner {
    yTUSDAddress = _yTUSDAddress;
  }
  
  function mint(address _to, uint256 _amount) public onlyYTUSD {
    _mint(_to, _amount);
  }

  function burn(address _to, uint256 _amount) public onlyYTUSD {
    _burn(_to, _amount);
  }

	/// To change how many tokens the users get. 
	/// Right now it's at 10k which means 1 million TUSD staked = 100 yeld a day
